...
void initFunctionBox(FunctionBox* box, sf::Rect<int> rect) {
	...
	*/
	...
	setButtonIcon(&box->deleteBtn, "Resources/deleteIcon32x32.png");
	...
	setButtonIcon(&box->randomFunctionBtn, "Resources/diceIcon32x32.png");
	...
	setButtonIcon(&box->detailsBtn, "Resources/detailsIcon48x48.png");
...
void initFunctionManagerPage(FunctionManagerPage* page, sf::Rect<int> rect) {
	...
	setButtonIcon(&page->addButton, "Resources/addIcon48x48.png");
	...
	setButtonIcon(&page->saveToFileButton, "Resources/pictureIcon32x32.png");
