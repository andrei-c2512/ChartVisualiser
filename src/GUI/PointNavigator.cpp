...
void initPointNavigator(PointNavigator* navigator,sf::Rect<int> rect) {
	...
	setButtonIcon(&navigator->btnUp, "Resources/goUpIcon48x48.png");
	...
	setButtonIcon(&navigator->btnDown, "Resources/goDownIcon48x48.png");
	...
	setButtonIcon(&navigator->goThereBtn, "Resources/goThereIcon48x48.png");
