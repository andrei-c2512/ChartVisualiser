...
void initOptionTab(OptionTab* tab, sf::Rect<int> rect) {
	...
	setButtonIcon(list[Options::FunctionList], "Resources/functionIcon64x60.png");
	setButtonIcon(list[Options::Analysis]    , "Resources/analysisIcon64x64.png");
	setButtonIcon(list[Options::Settings]    , "Resources/settingsIcon64x64.png");

	list[Options::Help]->rect.top = rect.top + rect.height - baseHeight;
	list[Options::Help]->rect.left = tab->rect.left - 3;
	setButtonIcon(list[Options::Help]        , "Resources/questionMarkIcon64x64.png");
