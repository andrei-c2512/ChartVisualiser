...
void initHelpPage(HelpPage* page, sf::Rect<int> rect) {
	page->rect = rect;
	if (!page->texture.loadFromFile("Resources/keyboard320x360.png"))
	...
	if (!page->mouseLeftTexture.loadFromFile("Resources/mouseLeft160x160.png"))
	...
	if (!page->mouseRightTexture.loadFromFile("Resources/mouseRight160x160.png"))
		std::cout << "Failed to load image in help page";
